...
const isRedirecting = useRef(false);
  ...
  const login = () => {
    ...
    const authUrl = `${EVE_AUTH_URL}?response_type=${RESPONSE_TYPE}&redirect_uri=${encodeURIComponent(REDIRECT_URI)}&client_id=${CLIENT_ID}&scope=${encodeURIComponent(SCOPE)}&state=${state}`;
